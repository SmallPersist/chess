...
public class Rule {
	...
	// 卒子的移动规则
	public boolean armsRule(int Man, JLabel play, MouseEvent e) {
		// 黑卒向下
		if(Man < 21) {
	...
	// 炮的移动规则
	public boolean cannonRule(JLabel choosen, JLabel[] play, MouseEvent e) {
		...
		System.out.println("pass cannon rule...");
		// 根据行标，列表确定放的位置
	...
	// 马移动
	public boolean horseRule(JLabel choosen, JLabel[] play, MouseEvent e) {
		int[] curPos 	= Util.getPosition(choosen.getX(), choosen.getY());
		int[] targetPos	= Util.getPosition(e.getX(), e.getY());
		...
		System.out.println("pass horse rule...");
		// 根据行标，列表确定放的位置
		int[] targetCordinate = Util.getCordinate(targetPos[0], targetPos[1]);
		choosen.setBounds(targetCordinate[0], targetCordinate[1], 55, 55);
	...
	public boolean horseRuleEat(JLabel choosen, JLabel target, JLabel[] play) {
		...
		System.out.println("pass horse eat rule...");
		target.setVisible(false);
		choosen.setBounds(target.getX(), target.getY(), 55, 55);
		target.setBounds(-1, -1, 0, 0);
		return true;
	...
	public boolean elephantRule(int type, JLabel choosen, JLabel[] play, MouseEvent e) {
		int[] curPos 	= Util.getPosition(choosen.getX(), choosen.getY());
		int[] targetPos	= Util.getPosition(e.getX(), e.getY());
		...
		System.out.println("pass elephat rule...");
		// 根据行标，列表确定放的位置
		int[] targetCordinate = Util.getCordinate(targetPos[0], targetPos[1]);
		choosen.setBounds(targetCordinate[0], targetCordinate[1], 55, 55);
	...
	public boolean chapRule(int type, JLabel choosen, MouseEvent e, JLabel[] play) {
		int[] curPos 	= Util.getPosition(choosen.getX(), choosen.getY());
		int[] targetPos	= Util.getPosition(e.getX(), e.getY());
	...
	// 将帅的移动
	public boolean willRule(int type, JLabel choosen, MouseEvent e, JLabel[] play) {
		int[] curPos 	= Util.getPosition(choosen.getX(), choosen.getY());
		int[] targetPos	= Util.getPosition(e.getX(), e.getY());
		...
		System.out.println("pass will rule...");
		// 根据行标，列表确定放的位置
		int[] targetCordinate = Util.getCordinate(targetPos[0], targetPos[1]);
		choosen.setBounds(targetCordinate[0], targetCordinate[1], 55, 55);
